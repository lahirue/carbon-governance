...
public interface StorageProvider {
    ...
    TaxonomyDocumentBean getTaxonomy(String name);

    void removeTaxonomy(String name);

    void addTaxonomy(TaxonomyDocumentBean documentBean);

    void updateTaxonomy(String oldName, TaxonomyDocumentBean documentBean);

    List<String> getTaxonomiesByRXT(String name);
}
