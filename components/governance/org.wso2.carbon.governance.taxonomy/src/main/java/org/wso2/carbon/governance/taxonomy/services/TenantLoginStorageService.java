...
public class TenantLoginStorageService extends AbstractAxis2ConfigurationContextObserver {
     ...
     */
    @Override public void createdConfigurationContext(ConfigurationContext configContext) {
        ...
        try {
            ...
            log.error(
                    "Error occurred while getting taxonomy files from registry when initializing taxonomy storage "
                            + "service", e);
        } catch (IOException e) {
